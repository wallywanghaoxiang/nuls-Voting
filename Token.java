...
public interface Token {
    ...
    boolean transfer(@Required Address to, @Required String transfermark ,@Required BigInteger value);

    boolean transferFrom(@Required Address from, @Required Address to, @Required String transfermark ,@Required BigInteger value);
    ...
    class TransferEvent implements Event {
        ...
        public TransferEvent(Address from, @Required Address to,String transfermark, @Required BigInteger value) {
            this.from = from;
            this.to = to;
            this.value = value;
